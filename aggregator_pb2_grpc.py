...
class AggregatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SaveFaceAttributes = channel.unary_unary(
                ...
                request_serializer=aggregator__pb2.FaceAttributesRequest.SerializeToString,
...
def add_AggregatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SaveFaceAttributes': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=aggregator__pb2.FaceAttributesRequest.FromString,
...
class Aggregator(object):
    ...
    def SaveFaceAttributes(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/aggregator.Aggregator/SaveFaceAttributes',
            aggregator__pb2.FaceAttributesRequest.SerializeToString,
